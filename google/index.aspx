<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Oxford.Speech.JS.google.index" %>
...
<div class="container">
        ...
        <div class="row">
            <div class="col s12 m12">
                <div class="card-panel">
                    <h1 class="center text-white" id="headline">
                      Google Speech Demo</h1>
                    <div id="info">
    ...
    go to chrome://settings/contentExceptions#media-stream
     ...
     Upgrade to <a href="//www.google.com/chrome">Chrome</a>
                    ...
                    <div class="right">
                        <button id="start_button" onclick="startButton(event)" style="display:block;visibility:visible;">
                            <img id="start_img" src="/google/mic.gif" alt="Start"></button>
                    </div>
                    <div id="results">
                    ...
                    <div class="center">
                        ...
                        <p>
                            <div id="div_language">
                                <select id="select_language" style="display:block;" onchange="updateCountry()"></select>
                                &nbsp;&nbsp;
   
                                        <select id="select_dialect" style="display:block;"></select>
                            </div>
                    </div>
                ...
                <script>
                    ...
                    if (!('webkitSpeechRecognition' in window)) {
                        ...
                        recognition.onstart = function () {
                            ...
                            start_img.src = '/google/mic-animate.gif';
                        };

                        recognition.onerror = function (event) {
                            if (event.error == 'no-speech') {
                                start_img.src = '/google/mic.gif';
                    ...
                    function startButton(event) {
                        ...
                        start_img.src = '/google/mic-slash.gif';
                        showInfo('info_allow');
                        showButtons('none');
